...
class Widgetkit_Admin
{
    ...
    public function widgetkit_for_elementor_admin_page_scripts()
    {
        ...
        wp_enqueue_script('widgetkit-elementor-admin-js', plugins_url('/assets/js/admin.js', __FILE__), ['jquery', 'jquery-ui-tabs'], '1.0', true);
        wp_enqueue_script('widgetkit-sweet-js', plugins_url('/assets/js/core.js', __FILE__), ['jquery'], '1.0', true);
        wp_enqueue_script('widgetkit-sweetalert2-js', plugins_url('/assets/js/sweetalert2.min.js', __FILE__), ['jquery', 'widgetkit-sweet-js'], '1.0', true);
        wp_enqueue_script('admin-notice-js', plugins_url('/assets/js/admin-notice.js', __FILE__), ['jquery'], '1.0', true);
        // Uikit
