...
class WKFE_Addons_Integration{
    ...
    public function widgetkit_register_frontend_styles(){
        wp_register_style( 'widgetkit_base', WKFE_URL.'assets/css/base.css', array(), WKFE_VERSION, 'all');
    ...
    public function widgetkit_register_frontend_scripts(){
        ...
        wp_register_script( 'animate-js', WKFE_URL.'assets/js/animate-text.js' , array('jquery'), WKFE_VERSION, true);
        ...
        wp_register_script( 'widgetkit-slider-3', WKFE_URL.'assets/js/slider-3.js' , array('jquery'), WKFE_VERSION, true);
