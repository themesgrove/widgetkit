<?php
    ...
    class WidgetKit_For_Elementor {
        ...
        public function __construct() {
            ...
            add_action( 'plugins_loaded', array( $this, 'wkfe_addons_elementor_setup' ) );
            add_action( 'init', array( $this, 'init' ), -999 );
        }

        public function wkfe_addons_elementor_setup() {
            $this->init_files(); 
            $this->load_domain();
        }
    ...
    if (class_exists('WidgetKit_For_Elementor')) {
        ...
        // $widgetkit_for_elementor->widgetkit_for_elementor_widget_bundle(); // load all addon php files
        $widgetkit_for_elementor->widgetkit_for_elementor_register(); // load addon resources
